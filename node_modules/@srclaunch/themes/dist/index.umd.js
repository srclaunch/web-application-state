(function(n,c){typeof exports=="object"&&typeof module!="undefined"?c(exports,require("react"),require("styled-components")):typeof define=="function"&&define.amd?define(["exports","react","styled-components"],c):(n=typeof globalThis!="undefined"?globalThis:n||self,c(n.themes={},n.React,n.styled))})(this,function(n,c,p){"use strict";function u(r){return r&&typeof r=="object"&&"default"in r?r:{default:r}}var m=u(c),k=`html,
body,
#root {
 ...
 */var _=m.default,x=60103;if(s.Fragment=60107,typeof Symbol=="function"&&Symbol.for){var f=Symbol.for;x=f("react.element"),s.Fragment=f("react.fragment")}var T=_.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,L=Object.prototype.hasOwnProperty,P={key:!0,ref:!0,__self:!0,__source:!0};function v(r,e,t){var o,g={},l=null,b=null;t!==void 0&&(l=""+t),e.key!==void 0&&(l=""+e.key),e.ref!==void 0&&(b=e.ref);for(o in e)L.call(e,o)&&!P.hasOwnProperty(o)&&(g[o]=e[o]);if(r&&r.defaultProps)for(o in e=r.defaultProps,e)g[o]===void 0&&(g[o]=e[o]);return{$$typeof:x,type:r,key:l,ref:b,props:g,_owner:T.current}}s.jsx=v,s.jsxs=v,d.exports=s;const E=d.exports.jsx,R=d.exports.jsxs,D=c.memo(({className:r="",children:e,theme:t,themes:o})=>{var b;const[g,l]=c.useState((b=o==null?void 0:o.find(a=>a.id===t))!=null?b:i);return c.useEffect(()=>{if(t&&o){const a=o.find(U=>U.id===t);l(a||i)}else l(i)},[t]),R("div",{className:`${g.id} ${r} theme-provider`,style:{display:"flex",flexGrow:1,overflow:"hidden"},children:[E(N,{theme:g}),e]})}),N=p.createGlobalStyle(["",";"],r=>r.theme.css);n.AppLabDarkTheme=y,n.AppLabLightTheme=i,n.ThemeProvider=D,Object.defineProperties(n,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
