 ...
 */var _=m.default,v=60103;b.Fragment=60107;if(typeof Symbol=="function"&&Symbol.for){var h=Symbol.for;v=h("react.element"),b.Fragment=h("react.fragment")}var L=_.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,T=Object.prototype.hasOwnProperty,P={key:!0,ref:!0,__self:!0,__source:!0};function x(r,e,t){var o,g={},l=null,a=null;t!==void 0&&(l=""+t),e.key!==void 0&&(l=""+e.key),e.ref!==void 0&&(a=e.ref);for(o in e)T.call(e,o)&&!P.hasOwnProperty(o)&&(g[o]=e[o]);if(r&&r.defaultProps)for(o in e=r.defaultProps,e)g[o]===void 0&&(g[o]=e[o]);return{$$typeof:v,type:r,key:l,ref:a,props:g,_owner:L.current}}b.jsx=x;b.jsxs=x;i.exports=b;const E=i.exports.jsx,C=i.exports.jsxs,D=c.memo(({className:r="",children:e,theme:t,themes:o})=>{var a;const[g,l]=c.useState((a=o==null?void 0:o.find(n=>n.id===t))!=null?a:s);return c.useEffect(()=>{if(t&&o){const n=o.find(u=>u.id===t);l(n||s)}else l(s)},[t]),C("div",{className:`${g.id} ${r} theme-provider`,style:{display:"flex",flexGrow:1,overflow:"hidden"},children:[E(N,{theme:g}),e]})}),N=p.createGlobalStyle(["",";"],r=>r.theme.css);exports.AppLabDarkTheme=y;exports.AppLabLightTheme=s;exports.ThemeProvider=D;
